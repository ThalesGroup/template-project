This SECURITY.md is a good example from [TensorFlow](https://github.com/tensorflow/tensorflow/blob/master/SECURITY.md) and can easily adapted to your needs.
