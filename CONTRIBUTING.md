This CONTRIBUTING.md is a good example from [TensorFlow](https://github.com/tensorflow/tensorflow/blob/master/CONTRIBUTING.md) and can easily adapted to your needs.
